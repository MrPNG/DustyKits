...
public class MOTDUtils {
	...
	private static final String MOTD_OFFLINE = Text.of("O servidor ainda nao esta aberto...").color(TextColor.RED).toString();
	
	private static final String MOTD_MAINTENANCE = Text.of("Em manutencao...").color(TextColor.RED).toString();
