...
object MOTDUtils {
    ...
    private val MOTD_MAIN = Text.of("Dusty")
            .color(TextColor.GOLD)
            .append(" - ")
            .color(TextColor.GRAY)
            .toString()

    private val MOTD_ALTERNATE = arrayOf(Text.of("Venha jogar!").color(TextColor.DARK_AQUA).toString(), Text.of("Divirta-se com seus amigos!")
            .color(TextColor.DARK_AQUA).toString())

    private val MOTD_SECONDARY = arrayOf(Text.of("Visite loja.dusty.com.br!").color(TextColor.GREEN).toString(), Text.of("Veja seu perfil em dusty.com.br/perfil!")
