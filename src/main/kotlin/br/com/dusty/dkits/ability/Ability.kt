...
//	                                    && !Main.REGION_MANAGER!!.getApplicableRegions(gamer.player.location).allows(DefaultFlag.INVINCIBILITY) //TODO: 1.8 switch
...
//	                                       && !Main.REGION_MANAGER!!.getApplicableRegions(receptor.player.location).allows(DefaultFlag.INVINCIBILITY) //TODO: 1.8 switch
}
